...
class Config:
    ...
    def __init__(self, env_path: str = ".env"):
        ...
        # ----- Monthly Review (theo yeu cau CuongNT 2026-09-18): moi thang tu
        # tong hop lenh da gui + cham diem theo nguong co dinh (khong goi API
        # nao - CuongNT chon phuong an mien phi hoan toan thay vi goi Claude
        # API that de tranh phai nap tien vao tai khoan Anthropic). Xem
        # src/ai_review/monthly_report.py + run_monthly_review.py. -----
